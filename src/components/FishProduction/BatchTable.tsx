        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-[#F9FAFB]">
              ...
              <th className="text-left py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Species</th>
              <th className="text-left py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Location</th>
              <th className="text-right py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Stocked</th>
              <th className="text-right py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Current</th>
              <th className="text-left py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Survival</th>
              <th className="text-right py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Mortality</th>
              <th className="text-left py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Stage</th>
              <th className="text-left py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Health</th>
              <th className="text-left py-3.5 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Harvest</th>
          ...
          <tbody>
            {paginatedBatches.map(batch => {
              ...
              return (
                <tr key={batch.id} className="border-b border-gray-100 hover:bg-green-50/30 transition-colors h-[68px]">
                  ...
                  <td className="py-3 px-4 text-right text-gray-700">{batch.quantityStocked.toLocaleString()}</td>
                  <td className="py-3 px-4 text-right font-bold text-gray-900">{batch.currentQuantity.toLocaleString()}</td>
                  <td className="py-3 px-4"><SurvivalProgress percentage={survivalRate} /></td>
                  ...
                  <td className="py-3 px-4"><BatchStatusBadge stage={batch.growthStage} /></td>
                  <td className="py-3 px-4"><HealthStatusBadge status={healthStatus} /></td>
                  <td className="py-3 px-4 text-gray-700 text-sm">{batch.expectedHarvestDate}</td>
                  <td className="py-3 px-4 text-right">
